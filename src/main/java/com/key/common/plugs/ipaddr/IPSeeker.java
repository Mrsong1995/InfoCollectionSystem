...
import com.key.common.plugs.ipaddr.IPEntry;
import com.key.common.plugs.ipaddr.Utils;
...
public class IPSeeker {
	...
	private static final Resource RESOURCE = new ClassPathResource("static/qqwry.dat");
	//	private static final String IP_FILE = RESOURCE.toString().substring(5);
	// 一些固定常量，比如记录长度等等
