...
public class SysPropertyController {
	...
	public String save(HttpServletRequest request) throws Exception {
		...
		if(loginBgImg!=null){
			...
			writeData(request,loginbgimgPath, loginbgimg);
		}
	...
	private void writeData(HttpServletRequest request,String filePath,String data) {
	...
	private void writeData(HttpServletRequest request,String filePath,Properties props) {
		OutputStreamWriter fw = null;
		try {
			ServletContext sc = request.getSession().getServletContext();
