...
//		Survey survey=(Survey) session.get(Survey.class, surveyId);
        SurveyDirectory survey = surveyDirectoryMapper.selectByPrimaryKey(surveyId);
//		System.out.println("survey:"+survey);
        ...
        surveyDirectoryMapper.updateByPrimaryKeySelective(survey);//更新回答数
        ...
        if (surveyAnswer.getId() == null) {
            surveyAnswerMapper.insertSelective(surveyAnswer);
        } else {
            surveyAnswerMapper.updateByPrimaryKeySelective(surveyAnswer);
        }
        int anCount = 0;
        //保存答案
        //是非题
...
//				surveyStatsManager.save(surveyStats);
                int result = surveyStatsMapper.insertSelective(surveyStats);
            }
        } else {
...
//			surveyStatsManager.save(surveyStats);
            ...
            for (String key : chenScoreMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    for (String keyCol : mapRow.keySet()) {
                        ...
                        anChenScoreMapper.insertSelective(anChenScore);
                    }
                }
            }
        }
        ...
        if (quOrderMaps != null) {
            for (String key : quOrderMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    anOrderMapper.insertSelective(anScore);
                }
            }
        }
        return answerQuCount;
            ...
            for (String key : compChenRadioMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    for (String keyCol : mapRow.keySet()) {
                        ...
                        anCompChenRadioMapper.insertSelective(anCompChenRadio);
                    }
                }
            }
        }
            ...
            for (String key : chenFbkMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    for (String keyCol : mapRow.keySet()) {
                        ...
                        anChenFbkMapper.insertSelective(anChenFbk);
                    }
                }
            }
        }
            ...
            for (String key : chenCheckboxMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    for (String keyCol : mapRow.keySet()) {
                        ...
                        anChenCheckboxMapper.insertSelective(anChenCheckbox);
                    }
                }
            }
        }
        ...
        if (chenRadioMaps != null) {
            for (String key : chenRadioMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    anChenRadioMapper.insertSelective(anChenRadio);
                }
            }
        }
        return answerQuCount;
        ...
        if (scoreMaps != null) {
            for (String key : scoreMaps.keySet()) {
                ...
                for (String keyRow : mapRows.keySet()) {
                    ...
                    anScoreMapper.insertSelective(anScore);
                }
            }
        }
        return answerQuCount;
    ...
    private int saveEnumMaps(SurveyAnswer surveyAnswer,
        ...
        for (String key : enumMaps.keySet()) {
            ...
            anEnumquMapper.insertSelective(anAnswer);
        }
        return answerQuCount;
    }
    ...
    private int saveAnFillMaps(SurveyAnswer surveyAnswer,
        ...
        for (String key : fillMaps.keySet()) {
            ...
            anFillblankMapper.insertSelective(anFillblank);
        }
        return answerQuCount;
    }
...
//				String quItemId=map.get(keyMap).toString();
        ...
        for (String key : dfillMaps.keySet()) {
            ...
            if (map != null && map.size() > 0) {
                for (String keyMap : map.keySet()) {
                    ...
                    anDFillblankMapper.insertSelective(anDFillblank);
                }
            }
        }
        return answerQuCount;
    ...
    private int saveAnRadioMaps(SurveyAnswer surveyAnswer,
        ...
        if (radioMaps != null)
            for (String key : radioMaps.keySet()) {
                ...
                anRadioMapper.insertSelective(anRadio);
            }
        return answerQuCount;
    }
    ...
    public int saveAnYesnoMaps(SurveyAnswer surveyAnswer, Map<String, Object> yesnoMaps, Session session) {
        ...
        for (String key : yesnoMaps.keySet()) {
            ...
            anYesnoMapper.insertSelective(anYesno);
        }
        return answerQuCount;
    }
