...
$(document).ready(function () {
            ...
            buttons: {
                ...
                "llll": {
                    ...
                    click: function () {
                        //$( this ).dialog( "close" );
                        var surveyId = $("#id").val();
                        window.location.href = ctx + "/design/my-survey-design/execute?surveyId=" + surveyId;
                    }
                },
                "CENCEL": {
                    text: "退出",
                    click: function () {
                        //$( this ).dialog( "close" );
                        window.location.href = ctx + "/design/my-survey/list";
                    }
                }
            },
    ...
    $(".sur_edit").click(function () {
        //${ctx }/design/my-survey-design.controller?surveyId=${surveyId}
