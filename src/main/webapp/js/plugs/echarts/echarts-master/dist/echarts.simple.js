...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function ECharts (dom, theme, opts) {
	        ...
	        // Can't dispatch controller during rendering procedure
	    ...
	    var updateMethods = {
	        ...
	        update: function (payload) {
	            ...
	            // Undo (restoration of total ecModel) can be carried out in 'controller' or outside API call.
	    ...
	    echartsProto.dispatchAction = function (payload, silent) {
	        ...
	        // Follow the rule of controller batch
	        if (batched) {
	            eventObj = {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = Model.extend({
	         ...
	         *        no-payload situations or when target of controller is global.
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Prevent mouse event from being dispatched after Touch Events controller
