...
<%--		Powered by <a href="http://www.dwsurvey.net" style="text-decoration: none;color: gray;">DWSurvey</a>--%>
		Powered by <a href="" style="text-decoration: none;color: gray;">RUANCHUANG</a>
		&nbsp;&nbsp;&nbsp;Copyright © 2020
...
<%-- <div id="footer_wrapper">
	<div class="footer_menu">
		<ul>
            ...
            <li><a href="${ctx }/survey-lib.controller">问卷库</a></li>
            <li><a href="${ctx }/survey.controller" >在线问卷</a></li>
            <li><a href="${ctx }/survey-edu.controller">问卷学院</a></li>
        </ul>
	</div>
	<div id="footer">
