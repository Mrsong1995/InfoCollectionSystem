...
<head>
    ...
    <script type="text/javascript" src="${ctx }/js/plugs/clipboard.js/clipboard.js"></script>
    <script type="text/javascript" src="${ctx }/js/plugs/clipboard.js/clipboard.min.js"></script>
    <script type="text/javascript" src="${ctx }/js/plugs/clipboard.js/clipboard-action.js.js"></script>
...
<div class="creatgeSurveyStepBody">
    <div class="creatgeSurveyStepContent bodyCenter">
        <ul class="createSsUl">
            ...
            <li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span>
            </li>
            <li><a href="${ctx }/design/my-collect/execute?surveyId=${surveyId }"
                   class="clickHideMenu csscStep csscStep5 active"><span class="csscStepLeft">&nbsp;</span><span
                    class="csscStepCenter">数据收集</span><span class="csscStepRight">&nbsp;</span></a>
            </li>
            <li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span>
            </li>
            <li><a href="${ctx }/da/survey-report/defaultReport?surveyId=${surveyId}"
                   class="clickHideMenu csscStep csscStep6"><span class="csscStepLeft">&nbsp;</span><span
                    class="csscStepCenter">数据分析</span><span class="csscStepRight">&nbsp;</span></a>
                <div class="a-w-sel">
                    <div class="w-sel" style="margin-top: 4px;margin-left: 15px;">
                        <div class="selc">
                            <div class="selcc tbtag">
                                <div class="seli"><a class="nx-1"
                                                     href="${ctx }/da/survey-report/defaultReport?surveyId=${surveyId}">统计表格</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="surveyCollectMiddle">
                ...
                <div class="surveyCollectTop">
                    ...
                    <div class="surveyCollectInfoDiv">
						...
						状态：<span
                                class="collectInfoSpan surveyStateText">${survey.surveyState eq 0 ? '设计中':survey.surveyState eq 1?'收集中':survey.surveyState eq 2?'收集完成':'' }</span>&nbsp;&nbsp;&nbsp;&nbsp;
						参加人数：<span class="collectInfoSpan">${survey.answerNum }</span>
						</span>
                        <span class="surveyCollectInfoRight">
						发布时间：<span class="collectInfoSpan"><fmt:formatDate value="${survey.createDate }"
...
<%--                                        <div class="scmcRightTopLeftNote">复制下面的信息收集链接到QQ，微信，Email等工具中直接发给被收集用户</div>--%>
                                ...
                                <div>
									...
									${baseUrl }/dwsurvey/dws-answer/execute/${survey.sid }.html
									</span>
                                        <span class="scmcSurveyLinkRight"><span id="clipLinkSpan"
                                                                                style="display: none;">复制成功</span></span>
                                        <a href="#" style="display: block;" class="clipLink" id="clipLink"
                                           data-clipboard-action="copy"
                                           data-clipboard-target=""
                                           data-clipboard-text="${baseUrl }/dwsurvey/dws-answer/execute/${survey.sid }.html">复制链接</a>
                                        <a target="_blank"
                                           href="${baseUrl }/dwsurvey/dws-answer/execute/${survey.sid }.html"
                                           style="margin-left: 12px;background: rgb(130, 144, 154);width: 95px;height: 50px;text-align: center;border-radius: 3px;color: #ffffff;">打开</a>
                                    </div>
                                </div>
                            </div>
                            <div style="clear: both;"></div>
