...
<body>
	...
	<input type="hidden" id="ctxs" name="ctxs" value="${ctx}">
	<div class="creatgeSurveyStepBody">
		<div class="creatgeSurveyStepContent bodyCenter">
			<ul class="createSsUl">
				...
				<li><a href="${ctx }/design/my-collect/execute?surveyId=${surveyId }"  class="clickHideMenu csscStep csscStep5 active"><span class="csscStepLeft">&nbsp;</span><span class="csscStepCenter">数据收集</span><span class="csscStepRight" >&nbsp;</span></a>
				</li>
				<li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span></li>
		...
		<div class="main-tabs-content bodyCenter">
			<div class="tab-content">
				<div class="tab-content-collectTab">
					...
					<!--<a href="${ctx }/design/my-collect/execute?surveyId=${surveyId}&tabId=share" class="collectTab tabItem_4 active" ><span class="collectTabItemLeft">&nbsp;</span><span>社交分享</span></a>
		...
		<div id="dwBodyUser">
			<div class="surveyCollectMiddle">
				...
				<div class="surveyCollectMiddleContent">
					...
					<%-- <div class="scmcLeft">
						<ul>
							<li><a href="${ctx }/design/my-collect.controller?surveyId=${surveyId}" class="hover">答卷地址</a></li>
							<li><a href="${ctx }/design/my-collect.controller?surveyId=${surveyId}&tabId=weixin">微信收集</a></li>
							<!-- <li><a href="">发布互填</a></li> -->
							<li><a href="${ctx }/design/my-collect.controller?surveyId=${surveyId}&tabId=mail">邮件邀请</a></li>
							<li><a href="${ctx }/design/my-collect.controller?surveyId=${surveyId}&tabId=sitecomp">网站组件</a></li>
							<li><a href="${ctx }/design/my-collect.controller?surveyId=${surveyId}&tabId=iframe">IFrame内嵌</a></li>
						</ul>
					</div> --%>
					<!-- <div class="scmcRight">
