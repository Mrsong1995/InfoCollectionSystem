...
<div id="wrap">
	...
	<div class="creatgeSurveyStepBody">
		<div class="creatgeSurveyStepContent bodyCenter">
				<a href=""  class="csscStep csscStep4"><span class="csscStepLeft">&nbsp;</span><span class="csscStepCenter">设计模板</span><span class="csscStepRight">&nbsp;</span></a>
		...
		<div class="main-tabs-content bodyCenter">
			<div class="tab-content">
				<div class="tab-content-collectTab">
					...
					<%-- <a href="${ctx }/design/my-collect/execute?surveyId=${surveyId}&tabId=iframe" class="collectTab tabItem_6 active"><span class="collectTabItemLeft">&nbsp;</span><span>IFrame嵌入</span></a> --%>
