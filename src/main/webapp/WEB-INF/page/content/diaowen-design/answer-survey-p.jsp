...
<form id="surveyForm" action="${ctx }/dwsurvey/dws-answer/save" method="post" >
					...
					<div class="surveyQuItemBody">
							<div class="surveyQuItem">
								...
								<div id="jcaptchaImgBody" class="r-qu-body" style="display: none;">
									...
									&nbsp;<img id="jcaptchaImg" alt="点击刷新" src="${ctx }/jcaptcha.controller"  align="top">
									&nbsp;点击图片刷新 --%>
								</div>
								...
								<div class="surveyQuItemContent" style="padding-top: 12px;height: 30px;min-height: 30px;">
									...
									&nbsp;&nbsp;
									<%-- <a href="${ctx }/report.controller?sid=${survey.sid}" style="color: gray;text-decoration: none;" target="_blank">查看结果</a> --%>
									<c:if test="${pageNo > 1 }">
									<a href="#" class="sbtn24 sbtn24_1 prevPage_a">上一页</a>
									<input type="hidden" name="prevPageNo" value="${pageNo-1 }">
									</c:if>
...
function refreshAutoCode(codeImgId){
	var ctx=$("#ctx").val();
	$("#"+codeImgId).attr("src",ctx+"/jcaptcha.controller");
}

//判则判断 
var url="${ctx}/dwsurvey/dws-answer/ajaxCheckSurvey";
