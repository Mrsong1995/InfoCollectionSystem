	...
	$("#inputForm").validate({
		rules:{
			...
			email:{
				required:true,
				email:true,
				//remote:'${ctx}/sy/yb/yang-ben!checkEmailUn.controller'
				remote:{
									...
									<tr>
										<td valign="top" align="left" >
											<table class="ac-form-table">
												<tr>
													<td width="80" align="right"><span class="red-color">&nbsp;</span></td>
													<td class="ac-input-td"><input type="hidden" name="id" value=<%=request.getParameter("id")%> readonly></td>
												</tr>
												<tr>
													<td width="80" align="right"><span class="red-color">*&nbsp;</span>登录名</td>
													<td class="ac-input-td"><input type="text"  name="loginName" value=<%=(request.getParameter("loginname")==null)?"":request.getParameter("loginname")%>   > </td>
												</tr>
												<tr>
													<td width="80" align="right"><span class="red-color">*&nbsp;</span>昵称</td>
													<td class="ac-input-td"><input type="text"  name="name" value=<%=(request.getParameter("name")==null)?"":request.getParameter("name")%>  > </td>
												</tr>
												<tr>
													<td width="80" align="right"><span class="red-color">*&nbsp;</span>邮箱</td>
													<td class="ac-input-td"><input type="text"  name="email" value=<%=(request.getParameter("email")==null)?"":request.getParameter("email")%> > </td>
												</tr>
