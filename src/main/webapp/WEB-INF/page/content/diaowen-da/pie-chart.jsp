		            	...
		            	<div class="w-sel" style="margin-top: 4px;">
		                	<div class="selc">
		                    	<div class="selcc tbtag">
		                            ...
		                            <div class="seli"><a class="nx-3" href="${ctx }/design/my-collect/execute?surveyId=${surveyId}&tabId=mail">邮件邀请</a></div>
		...
		<div class="main-tabs-content bodyCenter">
			<div class="tab-content">
				<div class="tab-content-collectTab">
					<a href="${ctx }/design/my-collect/execute?surveyId=${surveyId}" class="collectTab tabItem_1 active"><span class="collectTabItemLeft">&nbsp;</span><span>默认报告</span></a>
