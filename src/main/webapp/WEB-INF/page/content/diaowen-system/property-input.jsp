				...
				<div class="surveyCollectMiddleContent">
					<div style="padding: 25px 45px;overflow: auto;padding-top: 12px;">
							...
							<div style="padding: 5px;color: #666565;letter-spacing: 2px;font-size: 18px;">
								系统设置
							<%--&nbsp;&nbsp;|&nbsp;&nbsp;
							 <a href="${ctx }/sy/user/nosm/user-admin!input.controller" class="a-style-1" title="新用户">新账号</a> --%>
								<%-- <a href="${ctx }/sy/user/user-admin.controller" class="a-style-1" title="新用户">邮件设置</a> --%>
								<%-- <a href="${ctx }/sy/user/user-admin.controller" class="a-style-1" title="新用户">数据备份</a>
								&nbsp;&nbsp;|&nbsp;&nbsp; --%>
								<%-- <a href="${ctx }/sy/user/user-admin.controller" class="a-style-1" title="新用户">系统日志</a>
								&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="${ctx }/sy/user/user-admin.controller" class="a-style-1" title="新用户">激活</a> --%>
							</div>
